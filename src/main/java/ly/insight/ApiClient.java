...
import ly.insight.auth.Authentication;
import ly.insight.auth.HttpBasicAuth;
import ly.insight.auth.ApiKeyAuth;
import ly.insight.auth.OAuth;
...
public class ApiClient {
    ...
    public ApiClient() {
        ...
        setUserAgent("Swagger-Codegen/2.2/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.insight.ly/v2.2
