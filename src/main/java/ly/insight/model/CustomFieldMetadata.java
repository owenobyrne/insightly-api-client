...
public class CustomFieldMetadata implements Serializable {
  ...
  public CustomFieldMetadata FIELD_FOR(String FIELD_FOR) {
  ...
  **/
  ...
  public CustomFieldMetadata FIELD_TYPE(String FIELD_TYPE) {
  ...
  **/
  ...
  public CustomFieldMetadata DEFAULT_VALUE(Object DEFAULT_VALUE) {
  ...
  **/
  ...
  public CustomFieldMetadata CUSTOM_FIELD_ID(String CUSTOM_FIELD_ID) {
  ...
  **/
  ...
  public CustomFieldMetadata ORDER_ID(Long ORDER_ID) {
  ...
  **/
  ...
  public CustomFieldMetadata CUSTOM_FIELD_OPTIONS(List<APICustomFieldOption> CUSTOM_FIELD_OPTIONS) {
    this.CUSTOM_FIELD_OPTIONS = CUSTOM_FIELD_OPTIONS;
    return this;
  }

  public CustomFieldMetadata addCUSTOMFIELDOPTIONSItem(APICustomFieldOption CUSTOM_FIELD_OPTIONSItem) {
  ...
  **/
  ...
  public CustomFieldMetadata FIELD_NAME(String FIELD_NAME) {
  ...
  **/
  ...
  public CustomFieldMetadata EDITABLE(Boolean EDITABLE) {
  ...
  **/
  ...
  public CustomFieldMetadata FIELD_HELP_TEXT(String FIELD_HELP_TEXT) {
  ...
  **/
  ...
  public CustomFieldMetadata GROUP_ID(Long GROUP_ID) {
  ...
  **/
  ...
  public CustomFieldMetadata VISIBLE(Boolean VISIBLE) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.FIELD_FOR, customFieldMetadata.FIELD_FOR) &&
        Objects.equals(this.FIELD_TYPE, customFieldMetadata.FIELD_TYPE) &&
        Objects.equals(this.DEFAULT_VALUE, customFieldMetadata.DEFAULT_VALUE) &&
        Objects.equals(this.CUSTOM_FIELD_ID, customFieldMetadata.CUSTOM_FIELD_ID) &&
        Objects.equals(this.ORDER_ID, customFieldMetadata.ORDER_ID) &&
        Objects.equals(this.CUSTOM_FIELD_OPTIONS, customFieldMetadata.CUSTOM_FIELD_OPTIONS) &&
        Objects.equals(this.FIELD_NAME, customFieldMetadata.FIELD_NAME) &&
        Objects.equals(this.EDITABLE, customFieldMetadata.EDITABLE) &&
        Objects.equals(this.FIELD_HELP_TEXT, customFieldMetadata.FIELD_HELP_TEXT) &&
        Objects.equals(this.GROUP_ID, customFieldMetadata.GROUP_ID) &&
        Objects.equals(this.VISIBLE, customFieldMetadata.VISIBLE);
  }

  @Override
  public int hashCode() {
    return Objects.hash(FIELD_FOR, FIELD_TYPE, DEFAULT_VALUE, CUSTOM_FIELD_ID, ORDER_ID, CUSTOM_FIELD_OPTIONS, FIELD_NAME, EDITABLE, FIELD_HELP_TEXT, GROUP_ID, VISIBLE);
  }
